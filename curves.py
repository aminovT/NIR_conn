...
class Arc(Module):
    ...
    def forward(self, t):
        return torch.cat([self.a(t), 1.-self.a(t)-self.b(t), self.b(t)])
...
class Arc2(Module):
    ...
    def forward(self, t):
        return torch.cat([self.a(t), 0.*((1.-t)-self.a(t)), 0.*(t-self.b(t)), self.b(t)])
...
class CurveNet(Module):
    ...
    def init_rescale(self):
        ...
        for i in range(6, len(curve_parameters), 6):
