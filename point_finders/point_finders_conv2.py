...
class PointFinderStepWiseButterflyConvWBias(PointFinderSimultaneousData):
    ...
    @staticmethod
    def get_funcs(m, loader, layer, padding=1, kernel_size=3, stride=1, verbose=True):
        ...
        # every = max(len(functions) // 200_000, 1)
    ...
    def adjust_weights(self, f1, f2, W, verbose=True):
